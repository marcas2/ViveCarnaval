 ...
 */
final class Version20251005012209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SCHEMA calendar');
        $this->addSql('CREATE SCHEMA login');
        $this->addSql('CREATE TABLE calendar.evento (id SERIAL NOT NULL, titulo VARCHAR(255) NOT NULL, descripcion TEXT DEFAULT NULL, fecha TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ubicacion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE calendar.evento');
